  ...
  try {
    await mongoose
      .connect(
        ...
        `mongodb://${process.env.MONGO_DB_USER}:${process.env.MONGO_DB_PASSWORD}@cluster1-shard-00-00.2ur47.mongodb.net:27017,cluster1-shard-00-01.2ur47.mongodb.net:27017,cluster1-shard-00-02.2ur47.mongodb.net:27017/${process.env.MONGO_DB_DATABASE}?ssl=true&replicaSet=atlas-108e19-shard-0&authSource=admin&retryWrites=true&w=majority`,
        {
