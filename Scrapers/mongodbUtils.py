...
class MongoDbHandler:
    ...
    def connectDb(self, user, password, database):
        ...
        self.dbClient = pymongo.MongoClient(
            f'mongodb://{user}:{password}@cluster1-shard-00-00.2ur47.mongodb.net:27017,cluster1-shard-00-01.2ur47.mongodb.net:27017,cluster1-shard-00-02.2ur47.mongodb.net:27017/{database}?ssl=true&replicaSet=atlas-108e19-shard-0&authSource=admin&retryWrites=true&w=majority'
        # f'mongodb://{user}:{password}@onspotcluster0-shard-00-00.sltcg.mongodb.net:27017,onspotcluster0-shard-00-01.sltcg.mongodb.net:27017,onspotcluster0-shard-00-02.sltcg.mongodb.net:27017/{database}?ssl=true&replicaSet=atlas-lc5pm0-shard-0&authSource=admin&retryWrites=true&w=majority'
        )
