...
class GulAhmadScraper:
    ...
    def __init__(self):
        ...
        self.kidsCategories = ["girls/girls-eastern", "girls/girls-western", "boys"]
...
# products = scraper.startScraping("Men")
# pprint(products)
...
# mongodb.connectDb('onspot_team', 'onspot123', 'onSpot')
# subcats = products.keys()

# for subcat in subcats:
#     pprint(products[subcat])
#     mongodb.insertAll('products', products[subcat])
